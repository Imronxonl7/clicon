...
const FilterCard = ({ el, i }) => {
  const { cart, like, removeToLike, addToLike, addToCart, removeToCart } =
    useContext(CartContextCard);
  return (
    <div key={i} className="w-62 h-80 relative hover:shadow-[0px_8px_24px_0px_#191C1F1F] duration-300 transition-all   group border border-[#E4E7E9] p-4">
      {
      ...
      <div className="flex items-center gap-2">
        ...
        <p className="text-[12px] text-[#77878F] font-normal">(877)</p>
      </div>
      <div className="mt-2">
